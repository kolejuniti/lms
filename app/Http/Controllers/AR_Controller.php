...
class AR_Controller extends Controller
{
    ...
    public function getCourses(Request $request)
    {
        ...
        $data['allCourse'] = $getCourse->select('student_subjek.id as IDS', 'student_subjek.courseid', 'student_subjek.semesterid AS semester', 'sessions.SessionName', 'subjek.*')->get();
