    ...
    <div class="container-full">
        ...
        <div class="page-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h3 class="page-title mb-1 typewriter">Lecturer Report Dashboard</h3>
                ...
                <!-- Stats Cards - Fixed to work with Collections -->
                <div class="d-flex">
                            ...
                            <div class="stats-data">
                                @php
                                    ...
                                    foreach ($lecturer as $facultyLecturers) {
                                        $lecturerCount += $facultyLecturers->count();
                                    }
                                @endphp
                                ...
                                @php
                                    ...
                                    foreach ($course as $facultyCourses) {
                                        foreach ($facultyCourses as $lecturerCourses) {
                                            $courseCount += $lecturerCourses->count();
                                        }
                                    }
                                @endphp
                                                ...
                                                <div class="lecturer-group" data-filter-item data-filter-name="{{ strtolower($lct->name) }}">
                                                    <div class="lecturer-item ripple" data-toggle="lecturer-{{ $lct->ic }}">
                                                        ...
                                                        <div class="flex-shrink-0 ms-2" style="min-width: 30px;">
                                                            ...
                                                            <span class="status-badge status-active" title="Last Login: {{ $lct->lastLogin }}">
                                                                <i class="fa fa-check-circle"></i>
                                                            </span>
                                                            @else
                                                            <span class="status-badge status-inactive" title="Not Active">
                                                    ...
                                                    <div id="lecturer-{{ $lct->ic }}" class="lecturer-children" style="display:none;">
                                                        ...
                                                        <div class="course-item ripple hover-lift" 
                                                             ...
                                                             onclick="loadCourseContent('{{ $crs->id }}','{{ $lct->ic }}','{{ $crs->SessionID }}')">
...
function loadCourseContent(id, ic, ses) {
    ...
    return $.ajax({
        ...
        error: function(err) {
            ...
            $('#showMaterial').html(`
                <div class="preview-placeholder">
                    ...
                    <button class="btn btn-primary mt-3 ripple" onclick="loadCourseContent('${id}','${ic}','${ses}')">
        ...
        success: function(data) {
            // Add fade-in effect to loaded content
