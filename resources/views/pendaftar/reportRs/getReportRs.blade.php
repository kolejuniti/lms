...
<div class="card mb-3" id="stud_info">
    <div class="card-header">
    <b>Students Report Postponed</b>
    </div>
    <div class="card-body p-0">
      <table id="myTable5" class="table table-striped projects display dataTable">
        <thead>
            <tr>
                <th style="width: 1%">
                    No.
        ...
        <tbody id="table">
        @foreach ($data['postponed'] as $key => $rgs)
          <tr>
            <td>
            {{ $key+1 }}
            </td>
            ...
            <td>
            {{ $data['resultPostponed'][$key]->group_alias }}
            </td>
            <td>
            {{ $data['quaP'][$key] }}
            </td>
            <td>
            {{ $data['resultPostponed'][$key]->amount }}
            </td>
          </tr>
        @endforeach
        </tbody>
