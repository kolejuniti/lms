				  ...
				  <a href="{{ route('pendaftar') }}" class="{{ (route('pendaftar') == Request::url()) ? 'active' : ''}}"><i data-feather="users"></i><span>Student List</span></a>
							...
							<li class="treeview">
								...
								<ul class="treeview-menu treeview-menu-visible" id="treeview-menu-visible">
									...
									{{-- <li><a href="{{ route('pendaftar.student.viewstatus') }}" class="{{ (route('pendaftar.student.viewstatus') == Request::url()) ? 'active' : ''}}">Status Report</a>
							</li> --}}
							...
							{{-- @if(Auth::user()->email == 'norasiah@uniti.edu.my') --}}
