...
<style>
	...
	.count-circle {
		...
		padding: 5px 10px;
		/* Padding to make the circle look good */
		font-size: 12px;
		/* Font size */
		min-width: 24px;
		/* Minimum width to keep a circular shape */
		text-align: center;
		/* Center the text */
		line-height: 1;
		/* Align the text vertically */
		position: absolute;
		/* Position to adjust its placement */
		top: -5px;
	...
	li a {
		position: relative;
		/* Parent positioning so the count is correctly placed */
	}
</style>
						...
						<ul class="sidebar-menu" data-widget="tree">
							...
							<li class="treeview">
								...
								<ul class="treeview-menu treeview-menu-visible" id="treeview-menu-visible">
									...
									<li><a href="/KP/report/assessment2">Assessment</a></li>
								</ul>
							</li>
							<li>
							...
							{{-- <li>
					<a href="{{ route('lecturer.class.schedule') }}" class="{{ (route('lecturer.class.schedule') == Request::url()) ? 'active' : ''}}"><i data-feather="layout"></i><span>Timetable</span></a>
							</li> --}}
							<li class="treeview">
								...
								<ul class="treeview-menu treeview-menu-visible" id="treeview-menu-visible">
									...
									{{-- @if(Auth::user()->usrtype == 'PL' || Auth::user()->usrtype == 'AO')
						<li><a href="/AR/schedule/lecturer?type=lct" class="{{ (route('pendaftar_akademik.schedule.lecturer') == Request::url()) ? 'active' : ''}}">Lecturer Timetable</a>
							</li>
							@endif --}}
						...
						<div>
							<div class="d-flex flex-row">
								...
								<div class="ps-20">
									...
									<a href="mailto:">
										<span class="icon-Mail-notification me-5 text-success"><span class="path1"></span><span class="path2">{{ Auth::user()->email }}</span></span>
									</a>
								</div>
							</div>
						</div>
