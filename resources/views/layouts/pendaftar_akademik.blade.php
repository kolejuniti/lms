			  ...
			  <ul class="sidebar-menu" data-widget="tree">	
				...
				<li class="treeview">
					...
					<ul class="treeview-menu treeview-menu-visible" id="treeview-menu-visible">
						...
						<li><a href="{{ route('pendaftar_akademik.studentSubjectLecturerReport') }}" class="{{ (route('pendaftar_akademik.studentSubjectLecturerReport') == Request::url()) ? 'active' : ''}}">Student Subject - Lecturer Report</a></li>
				...
				<li class="treeview">
					...
					<ul class="treeview-menu treeview-menu-visible" id="treeview-menu-visible">
						...
						<li><a href="/AR/schedule/log/latest/lecturer" class="{{ (route('pendaftar_akademik.schedule.log.latestLecturer') == Request::url()) ? 'active' : ''}}">List Of Lecturers Timetable</a></li>
