    ...
    <section class="sidebar position-relative"> 
		  ...
		  <div class="multinav-scroll" style="height: 97%;">	
			  ...
			  <ul class="sidebar-menu" data-widget="tree">
				@if (Auth::user()->usrtype == 'PL')
				<li>
					<a href="{{ route('ketua_program') }}" class="{{ (route('ketua_program') == Request::url()) ? 'active' : ''}}"><i data-feather="home"></i><span>Home</span></a>
				</li>
				@else
				<li>
					<a href="{{ route('lecturer') }}" class="{{ (route('lecturer') == Request::url()) ? 'active' : ''}}"><i data-feather="home"></i><span>Home</span></a>
				</li>
				@endif
				<li>
					<a href="/lecturer/{{ Session::get('CourseID') }}" class=""><i data-feather="archive"></i><span>Course Summary</span></a>
				</li>
				<li>
					<a href="/lecturer/content/{{ Session::get('CourseID') }}" class=""><i data-feather="airplay"></i><span>Course Content</span></a>
				</li> 
				<li class="treeview">
				...
				<li class="treeview">
					...
					<ul class="treeview-menu treeview-menu-visible" id="treeview-menu-visible">
						...
						{{-- <li><a href="https://uniti.edu.my/wp-content/uploads/2022/08/index.htm" target="_blank" class="">Schedule</a></li> --}}
						<li class="treeview">
									<a href="#"><span>Attendance</span>
									</a>
							<ul class="treeview-menu treeview-menu-visible" id="treeview-menu-visible">
							<li><a href="/lecturer/class/attendance" class="">Attendance Check</a></li>
							<li><a href="/lecturer/class/attendance/report" class="">Attendance Record</a></li>
							</ul>
						</li>
						<li class="treeview">
						...
						<li class="treeview">
							...
							<ul class="treeview-menu treeview-menu-visible" id="treeview-menu-visible">
							<li><a href="/lecturer/class/onlineclass" class="">Create Class</a></li>
