          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                ...
                <!-- Finals Timetable -->
                <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-20">
                  <a href="{{ asset('storage/finals_schedule/Jadual Peperiksaan Akhir UNITI Semester II Sesi 20252026 (Kemasukan Mac).pdf') }}" target="_blank" class="d-block text-center p-20 bg-light rounded hover-shadow timetable-action">
                    <div class="timetable-icon-wrapper mb-15">
