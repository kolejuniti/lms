    ...
    <div class="container-full">
        ...
        <div class="page-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h3 class="page-title mb-1">Your Student Profile</h3>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input id="search-txt" placeholder="Search keywords..." type="text" class="form-control" autocomplete="off" aria-invalid="false" value="">
...
<script type="text/javascript">
    ...
    function getCourseList(search, session) {
        return $.ajax({
            ...
            url: "{{ url('student/course/filter') }}",
            method: 'POST',
            data: {search: search, session: session},
            error: function(err){
                Swal.fire({
                    title: "Error",
                    text: "Something went wrong while fetching courses",
                    icon: "error"
                });
                console.log(err);
            },
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        setTimeout(() => {
            Swal.fire({
                title: "Welcome Back!",
                text: "Your courses are ready for you",
                icon: "success",
                toast: true,
                position: 'top-end',
