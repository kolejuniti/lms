<div id="assignment-library" class="container-fluid">
    <div class="row g-4">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                <div class="quiz-card h-100 position-relative overflow-hidden">
                    ...
                    <div class="position-absolute top-0 end-0 m-3" style="z-index: 10;">
                        <span class="badge bg-info text-white px-3 py-2 rounded-pill shadow">
                            {{ $ag->statusname }}
                        </span>
                    </div>
                    ...
                    <div class="quiz-card-header p-4 text-center">
                        <div class="quiz-icon mb-3">
                            <i class="fa fa-tasks text-info" style="font-size: 4rem;"></i>
                        </div>
                    ...
                    <div class="quiz-card-body px-4 py-4">
                        ...
                        <div class="quiz-info mb-4">
                            <div class="quiz-type-badge text-center mb-3">
                                <span class="badge bg-info text-white px-3 py-2 rounded-pill">
                                    <i class="fa fa-file-text me-1"></i>ASSIGNMENT
                                </span>
                            </div>
                        ...
                        <div class="text-center">
                            <a href="{{ Storage::disk('linode')->url($ag->content) }}" 
                               target="_blank" 
                               class="btn btn-info btn-lg px-4 py-3 rounded-pill shadow hover-lift text-white fw-bold" 
                               data-bs-toggle="tooltip" 
                               data-bs-placement="top" 
                               title="Download Assignment"
                               style="text-decoration: none; border: none; background: linear-gradient(45deg, #17a2b8, #138496);">
...
.hover-lift:hover {
    ...
    box-shadow: 0 15px 30px rgba(23, 162, 184, 0.4) !important;
}
