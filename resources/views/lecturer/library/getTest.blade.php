            ...
            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                <div class="quiz-card h-100 position-relative overflow-hidden">
                    ...
                    <div class="position-absolute top-0 end-0 m-3" style="z-index: 10;">
                        <span class="badge {{ $ts->date_from != null ? 'bg-success text-white' : 'bg-secondary text-white' }} px-3 py-2 rounded-pill shadow">
                            {{ $ts->statusname }}
                        </span>
                    </div>
                    ...
                    <div class="quiz-card-header p-4 text-center">
                        <div class="quiz-icon mb-3">
                            @if ($ts->date_from != null)
                                <i class="fa fa-file-text text-warning" style="font-size: 4rem;"></i>
                            @else
                    ...
                    <div class="quiz-card-body px-4 py-4">
                        @if ($ts->date_from != null)
                            ...
                            <div class="text-center">
                                <a href="/lecturer/test/{{ Session::get('CourseID') }}/create?testid={{ $ts->id }}&REUSE=1" 
                                   ...
                                   style="text-decoration: none; border: none; background: linear-gradient(45deg, #ffc107, #e0a800);">
                                    <i class="fa fa-recycle me-2"></i>Reuse Test
                                </a>
                            </div>
                        @else
                            <!-- Offline Test Info -->
                            <div class="quiz-info mb-4">
                                ...
                                <p class="text-muted text-center mb-0">
                                    Download and view offline content
                                </p>
                            </div>
                            ...
                            <div class="text-center">
                                <a href="{{ Storage::disk('linode')->url($ts->content) }}" 
                                   ...
                                   data-bs-placement="top" 
                                   title="Download Test"
                                   style="text-decoration: none; border: 2px solid #ffc107; color: #ffc107;">
