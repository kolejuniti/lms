                  ...
                  <div class="box-body col-4" style="border: 1px solid blue;margin-right: 20px;">
                    <table class="table" id="myTable">
                      <tbody class="table-body">
                          ...
                          <tr id="demo-{{ $lct->ic }}" class="collapse cell-1 row-child" data-toggle="collapse" data-target="#demo-assessment">
                              <td>
                                  <div style="margin-left: 40px;">
                                      <i class="ti-folder" style="margin-right: 5px;"></i>
                                      Asessment
                          ...
                          <tr id="demo-assessment" class="collapse cell-1 row-child" data-toggle="collapse" data-target="#demo-" onclick="getQuiz('{{ $lct->ic }}')">
                            <td>
                          ...
                          <tr id="demo-assessment" class="collapse cell-1 row-child" data-toggle="collapse" data-target="#demo-" onclick="getTest('{{ $lct->ic }}')">
                            <td>
                                <div style="margin-left: 60px;">
                                    <i class="ti-folder" style="margin-right: 5px;"></i>
                                    Test
                          ...
                          <tr id="demo-assessment" class="collapse cell-1 row-child" data-toggle="collapse" data-target="#demo-" onclick="getAssignment('{{ $lct->ic }}')">
                            <td>
                                <div style="margin-left: 60px;">
                                    <i class="ti-folder" style="margin-right: 5px;"></i>
                                    Assignment
