    ...
    <div class="container-full">
        ...
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h4 class="page-title">Log Timetable ({{ $data['date'] }})</h4>
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('lecturer.class.schedule') }}"><i class="mdi mdi-home-outline"></i> Schedule</a></li>
                    ...
                    <div class="box">
                        <div class="box-body">
                            ...
                            <div class="box-footer">
                                @if($data['time'])
                                <h2 class="text-center">Published on {{ date('d M Y h:i A', strtotime($data['time'])) }}</h2>
                                @endif
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            events: function(fetchInfo, successCallback, failureCallback) {
                ...
                fetch('{{ route("lecturer.schedule.log.fetch") }}?idS={{ $data["date"] }}')
