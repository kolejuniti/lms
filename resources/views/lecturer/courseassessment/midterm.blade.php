                    ...
                    <div class="col-md-12 mb-3">
                        <div class="pull-right">
                            <button id="newFolder" class="waves-effect waves-light btn btn-primary btn-sm">
                                <i class="fa fa-plus"></i> <i class="fa fa-folder"></i> &nbsp New Midterm
                            </button>
                        </div>
                    </div>
                </div>
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="project-actions text-right" >
                                <a class="btn btn-success btn-sm mr-2" href="/lecturer/midterm/{{ Session::get('CourseIDS') }}/{{ $dt->id }}">
                                    <i class="ti-user">
                                    </i>
                                    Students
                                </a>
...
$(document).ready( function () {
    ...
    if (res.isConfirmed){
              $.ajax({
                  ...
                  url      : "{{ url('lecturer/midterm/deletemidterm') }}",
                  method   : 'POST',
                  data 	 : {id:id},
                  error:function(err){
                      alert("Error");
