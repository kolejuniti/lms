    ...
    <div class="container-full">
        ...
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h4 class="page-title">
                        {{ empty($data['practical']->title) ? "Create Practical" : $data['practical']->title }}
                    </h4>
                        ...
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Group Content</li>
                                    ...
                                    @if(empty($data['practical']->title))
                                        <li class="breadcrumb-item active" aria-current="page">Create Practical</li>
                                    @else
                                        <li class="breadcrumb-item active" aria-current="page">Practical</li>
                                        <li class="breadcrumb-item active" aria-current="page">{{ $data['practical']->title }}</li>
                                    @endif
                                </li>
        ...
        <section class="content">
            <div class="row">
                <form action="/lecturer/practical/insert" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="header-setting row">
                                <div class="row col-md-12">
                                    <div class="col-md-3 mb-4">
                                        <label for="practical-title" class="form-label "><strong>Practical Title</strong></label>
                                        <input type="text" oninput="this.value = this.value.toUpperCase()"  id="practical-title" name="practical-title" class="form-control"
                                            value="{{ empty($data['practical']->title) ? "" : $data['practical']->title }}" required>
                                    </div>
                                    <div class="col-md-2 mb-4">
                                        <label for="practical-duration" class="form-label "><strong>Practical Deadline</strong></label>
                                        <input type="datetime-local" oninput="this.value = this.value.toUpperCase()"  id="practical-duration" name="practical-duration" class="form-control"
                                            value="" required>
                                    </div>
                                    <div class="col-md-2 mb-4">
...
function getChapters(folder)
{
  ...
  return $.ajax({
        ...
        url      : "{{ url('lecturer/practical/getChapters') }}",
        method   : 'POST',
        data 	 : {folder: folder},
        error:function(err){
            alert("Error");
