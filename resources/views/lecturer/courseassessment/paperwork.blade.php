                    ...
                    <div class="col-md-12 mb-3">
                        <div class="pull-right">
                            <button id="newFolder" class="waves-effect waves-light btn btn-primary btn-sm">
                                <i class="fa fa-plus"></i> <i class="fa fa-folder"></i> &nbsp New Paperwork
                            </button>
                        </div>
                    </div>
                </div>
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="align-items-center">
                                <a href="{{ asset('storage/'. $dt->content) }}" download><i class="fa fa-file-pdf-o fa-3x"></i></a>
                              </td>
                              <td>
                                {{ $dt->deadline }}
                              </td>
                              <td class="project-actions text-right" >
                                <a class="btn btn-success btn-sm mr-2" href="/lecturer/paperwork/{{ Session::get('CourseIDS') }}/{{ $dt->id }}">
                                    <i class="ti-user">
                                    </i>
                                    Students
                                </a>
...
$(document).ready( function () {
    ...
    $(document).on('click', '#newFolder', function() {
        location.href = "/lecturer/paperwork/{{ Session::get('CourseID') }}/create";
    })
