...
<div class="content-wrapper">
    <div class="container-full">
        ...
        <section class="content">
            <div class="row">
                <form action="/lecturer/assign/insert" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="header-setting row">
                                <div class="row col-md-12">
                                    <div class="col-md-3 mb-4">
                                        <label for="assign-title" class="form-label "><strong>Assignment Title</strong></label>
...
function getChapters(folder)
{
  ...
  return $.ajax({
        ...
        url      : "{{ url('lecturer/assign/getChapters') }}",
        method   : 'POST',
        data 	 : {folder: folder},
        error:function(err){
            alert("Error");
