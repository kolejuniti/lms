    ...
    <div class="container-full">
        ...
        <div class="page-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h4 class="page-title">{{ $data['othertitle'] }} [Result]</h4>
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item" aria-current="page">Academics</li>
                                <li class="breadcrumb-item" aria-current="page">Extra</li>
                                <li class="breadcrumb-item" aria-current="page">{{ $data['othertitle'] }} [Result]</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-6 p-4">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-3"><b>other Title</b></div>
                        <div class="col-md-9">{{ $data['othertitle'] }}</div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-md-3"><b>Duedate</b></div>
                        <div class="col-md-9">{{ $data['otherdeadline'] }}</div>
                    </div>
                    <div class="row mb-2">
                    ...
                    <div class=" d-flex justify-content-center">
                        <div id="fb-rendered-form" class="card" style="width:800px">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h1 class="pull-left"> {{ $data['othertitle'] }}</h1>
                                ...
                                <hr>
                                <form action="/lecturer/other/updateotherresult?id={{ request()->otherid }}&participant={{ $data['IC'] }}" id="form-submit"  method="POST" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <div id="form-show" hidden>
                                    <div class="col-md-12 justify-content-center" style="float: center">
                                        <div class="col-md-3 text-center mb-3">
                                            <a href="{{ ($data['return'] == null) ? '' : Storage::disk('linode')->url($data['other']) }}">
                                                ...
                                                <div class="p-3">
                                                    {{ basename($data['other'])}} / {{ $extension = pathinfo(storage_path($data['other']), PATHINFO_EXTENSION); }}
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-12">
                                            <a id="done-btn" href="/lecturer/other/{{ Session::get('CourseIDS') }}/{{ $data['otherid'] }}" class="btn btn-success pull-right">Done</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
