        ...
        <section class="content">
            <div class="row">
                <div class="col-md-6 p-4">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-3"><b>assign Title</b></div>
                    ...
                    <div class=" d-flex justify-content-center">
                        <div id="fb-rendered-form" class="card" style="width:800px">
                            <div class="card-body">
                                ...
                                <hr>
                                <form action="/lecturer/assign/updateassignresult?id={{ request()->assignid }}&participant={{ $data['IC'] }}" id="form-submit"  method="POST" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <div id="form-show" hidden>
                                    <div class="col-md-12 justify-content-center" style="float: center">
                                        ...
                                        <div class="col-md-3 text-center mb-3">
                                            <a href="{{ ($data['return'] == null) ? '' : asset('storage/'. $data['assign']) }}" download>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-12">
                                            <a id="done-btn" href="/lecturer/assign/{{ Session::get('CourseIDS') }}/{{ $data['assignid'] }}" class="btn btn-success pull-right">Done</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
