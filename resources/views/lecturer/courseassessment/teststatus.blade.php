                              ...
                              <tr>
                                ...
                                @if (count($status[$key]) > 0)
                                  ...
                                  <td class="project-actions text-center" >
                                                                        <a class="btn btn-success btn-sm mr-2" href="/lecturer/test/{{ request()->test }}/{{ $sts->userid }}/result" {{ !empty($period) ? '' : 'hidden' }}>
                                        <i class="ti-pencil-alt">
                                        </i>
                                        Answer
                                    </a>
                                    @if(date('Y-m-d H:i:s') >= $qz->date_from && date('Y-m-d H:i:s') <= $qz->date_to)
                                      <a class="btn btn-danger btn-sm mr-2" onclick="deleteStdTest('{{ $sts->id }}')" {{ !empty($period) ? '' : 'hidden' }}>
                                          <i class="ti-trash">
                                          </i>
                                          Delete
                                      </a>
