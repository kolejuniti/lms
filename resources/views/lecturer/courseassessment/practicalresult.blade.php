                    ...
                    <div class=" d-flex justify-content-center">
                        <div id="fb-rendered-form" class="card" style="width:800px">
                            <div class="card-body">
                                ...
                                <hr>
                                <form action="/lecturer/practical/updatepracticalresult?id={{ request()->practicalid }}&participant={{ $data['IC'] }}" id="form-submit"  method="POST" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <div id="form-show" hidden>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-12">
                                            <a id="done-btn" href="/lecturer/practical/{{ Session::get('CourseIDS') }}/{{ $data['practicalid'] }}" class="btn btn-success pull-right">Done</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
