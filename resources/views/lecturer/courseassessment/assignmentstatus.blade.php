                    ...
                    <div class="row">
                                ...
                                @if (count($status[$key]) > 0)
                                  ...
                                  <td style="width: 5%">
                                    @if (empty($sts))
                                      -
                                    @else
                                      @if (($sts->content == null) && ($sts->external_url == null))
                                      -
                                      @else
                                      @php
                      ...
                      $courseName = $course->course_name ?? '';
                                  ...
                                  <td class="project-actions text-center" >
                                    <a class="btn btn-success btn-sm mr-2" href="/lecturer/assign/{{ request()->assign }}/{{ $sts->userid }}/result" {{ $showButtons ? '' : 'hidden' }}>
                                ...
                                @else
                                  ...
                                  @endphp
                                  <td class="project-actions text-center">
                                    <a class="btn btn-success btn-sm mr-2" href="/lecturer/assign/{{ request()->assign }}/{{ $qz->student_ic }}/result" {{ $showButtons ? '' : 'hidden' }}>
                                        <i class="ti-pencil-alt">
                                        </i>
                                        Answer
                                    </a>
                                    <a class="btn btn-danger btn-sm mr-2 disabled" href="javascript:void(0)" aria-disabled="true" tabindex="-1" {{ $showButtons ? '' : 'hidden' }}>
                                      <i class="ti-trash">
                                      </i>
                                      Delete
                                    </a>
...
<script type="text/javascript">
    ...
    function getGroup(group)
    {
      ...
      return $.ajax({
            ...
            url      : "{{ url('lecturer/assign/' . request()->id . '/' . request()->assign . '/getGroup') }}",
            method   : 'POST',
            data 	 : {group: group},
            error:function(err){
                alert("Error");
