...
<script type="text/javascript">
    var selected_group = "";
    var selected_paperwork = "{{ request()->paperwork }}";
    ...
    $(document).on('change', '#group', function(e) {
        ...
        getGroup(selected_group,selected_paperwork);
    });

    function getGroup(group,paperwork)
    {

      return $.ajax({
            headers: {'X-CSRF-TOKEN':  $('meta[name="csrf-token"]').attr('content')},
            url      : "{{ url('lecturer/paperwork/getStatus') }}",
            method   : 'POST',
            data 	 : {group: group,paperwork: paperwork },
            error:function(err){
                alert("Error");
                console.log(err);
            },
