    ...
    <div class="container-full">
        ...
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h4 class="page-title">
                        {{ empty($data['assign']->title) ? "Create Assignment" : $data['assign']->title }}
                    </h4>
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Group Content</li>
                                    ...
                                    @else
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">{{ $data['assign']->title }}</li>
                                    @endif
                                </li>
        ...
        <section class="content">
            <div class="row">
                <form action="/lecturer/assign2/insert" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="header-setting row">
                                <div class="row col-md-12">
                                    <div class="col-md-3 mb-4">
                                        <label for="title" class="form-label "><strong>Assignment Title</strong></label>
                ...
                <div class="col-xl-12 col-12">
                    <div class="card" style="width:100%">
                        <div class="card-body">
                            <button id="publish-assignment"  class="btn btn-info pull-right m-1"><i class="mdi mdi-publish"></i> Save & Publish</button>
                        </div>
                    </div>
                </div>
                </form>
