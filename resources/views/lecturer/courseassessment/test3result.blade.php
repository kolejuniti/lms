                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-12">
                                        ...
                                        <a id="done-btn" href="/lecturer/test3/{{ Session::get('CourseIDS') }}/{{ $data['testid'] }}" class="btn btn-success pull-right" hidden>Done</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    document.getElementById('publish-result-btn').addEventListener('click', function() {
        ...
        if(total_all > total)
        {
            ...
            $.ajax({
                ...
                url: "{{ url('lecturer/test3/updatetestresult') }}",
                type: 'POST',
                data:  {
                    test: selected_test,
                ...
                success:function(res){
                    location.href = "/lecturer/test3/"+ selected_test +"/"+selected_participant+"/result";
                }
            });
