    ...
    <div class="container-full">
        ...
        <div class="page-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h4 class="page-title">
                        {{ empty($data['extra']->title) ? "Create Extra" : $data['extra']->title }}
                    </h4>
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Group Content</li>
                                    ...
                                    @else
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">{{ $data['extra']->title }}</li>
                                    @endif
                                </li>
        ...
        <section class="content">
            <div class="row">
                <form action="/lecturer/extra/insert" method="POST" enctype="multipart/form-data">
                @csrf
