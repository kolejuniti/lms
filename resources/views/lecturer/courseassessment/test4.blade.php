                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="project-actions text-right" >
                                <a class="btn btn-success btn-sm mr-2" href="/lecturer/test4/{{ Session::get('CourseIDS') }}/{{ $dt->id }}">
                                    <i class="ti-user">
                                    </i>
                                    Students
                                </a>
                                <a class="btn btn-info btn-sm btn-sm mr-2" href="/lecturer/test4/{{ Session::get('CourseID') }}/create?testid={{ $dt->id }}">
...
$(document).ready( function () {
    ...
    $(document).on('click', '#newFolder', function() {
        location.href = "/lecturer/test4/{{ Session::get('CourseID') }}/create";
    })
