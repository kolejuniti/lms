    ...
    <div class="container-full">
        ...
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h4 class="page-title">
                        {{ empty($data['paperwork']->title) ? "Create Paperwork" : $data['paperwork']->title }}
                    </h4>
                        ...
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Group Content</li>
                                    ...
                                    @if(empty($data['paperwork']->title))
                                        <li class="breadcrumb-item active" aria-current="page">Create Paperwork</li>
                                    @else
                                        <li class="breadcrumb-item active" aria-current="page">Paperwork</li>
                                        <li class="breadcrumb-item active" aria-current="page">{{ $data['paperwork']->title }}</li>
                                    @endif
                                </li>
        ...
        <section class="content">
            <div class="row">
                <form action="/lecturer/paperwork/insert" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="header-setting row">
                                <div class="row col-md-12">
                                    <div class="col-md-3 mb-4">
                                        <label for="paperwork-title" class="form-label "><strong>Paperwork Title</strong></label>
                                        <input type="text" oninput="this.value = this.value.toUpperCase()"  id="paperwork-title" name="paperwork-title" class="form-control"
                                            value="{{ empty($data['paperwork']->title) ? "" : $data['paperwork']->title }}" required>
                                    </div>
                                    <div class="col-md-2 mb-4">
                                        <label for="paperwork-duration" class="form-label "><strong>Paperwork Deadline</strong></label>
                                        <input type="datetime-local" oninput="this.value = this.value.toUpperCase()"  id="paperwork-duration" name="paperwork-duration" class="form-control"
                                            value="" required>
                                    </div>
                                    <div class="col-md-2 mb-4">
...
function getChapters(folder)
{
  ...
  return $.ajax({
        ...
        url      : "{{ url('lecturer/paperwork/getChapters') }}",
        method   : 'POST',
        data 	 : {folder: folder},
        error:function(err){
            alert("Error");
