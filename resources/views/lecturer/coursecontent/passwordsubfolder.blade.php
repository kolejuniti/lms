  ...
  <div class="container-full">
    ...
    <div class="content-header">
      <div class="d-flex align-items-center">
        <div class="me-auto">
          <h4 class="page-title">Check Password</h4>
          <div class="d-inline-block align-items-center">
            <nav>
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Check Password</li>
              </ol>
            </nav>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="/lecturer/content/material/sub/password/{{ $dir }}" method="POST">
                @csrf
                <div class="card-body">
                    <div class="col-md-6">
