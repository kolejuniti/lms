    ...
    <div class="container-full">
        ...
        <div class="page-header">
            <div class="d-flex align-items-center">
                ...
                <div class="d-flex">
                    <button id="newFolder" class="btn btn-action btn-primary-action">
                                ...
                                <div id="material-directory" class="row">
                                    ...
                                    <div class="col-md-3 col-sm-6 mb-4">
                                        <div class="material-card back-folder">
                                            <a href="/lecturer/content/material/prev/{{ $prev }}" class="text-decoration-none d-block">
                                    ...
                                    <div class="col-md-3 col-sm-6 mb-4">
                                        <div class="material-card position-relative">
                                            ...
                                            <a href="/lecturer/content/material/sub/content/{{ $fold->DrID }}" class="text-decoration-none d-block">
                                                <div class="text-center p-4">
                                                    <div class="folder-icon-container">
                                                        <div class="icon-background folder-icon-background">
                                                            <svg class="folder-icon" width="80" height="80" viewBox="0 0 309.27 309.27">
