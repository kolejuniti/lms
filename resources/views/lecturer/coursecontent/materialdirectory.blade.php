    ...
    <div class="container-full">
        ...
        <div class="page-header">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <button id="newFolder" class="btn btn-new-folder">
                                ...
                                <div id="material-directory" class="row">
                                    ...
                                    <div class="col-md-3 col-sm-6 mb-4">
                                        <div class="material-card back-folder">
                                            <a href="/lecturer/content/{{ Session::get('CourseID') }}" class="text-decoration-none d-block">
                                                <div class="text-center p-4">
                                                    ...
                                                    <h5 class="folder-name px-2">
                                                        <i class="ti ti-more-alt"></i> Back to Main
                                                    </h5>
                                                </div>
                                            </a>
                                    ...
                                    <div class="col-md-3 col-sm-6 mb-4">
                                        <div class="material-card position-relative">
                                            ...
                                            <a href="/lecturer/content/material/sub/{{ $fold->DrID }}" class="text-decoration-none d-block">
                                                <div class="text-center p-4">
                                                    <div class="folder-icon-container">
                                                        <div class="folder-icon-background">
                                                            <svg class="folder-icon" width="80" height="80" viewBox="0 0 309.27 309.27">
                                    ...
                                    <div class="col-12">
                                        <div class="empty-state">
                                            ...
                                            <button id="emptyStateNewFolder" class="btn btn-new-folder">
...
<script type="text/javascript">
    ...
    $(document).on('click', '#newFolder, #emptyStateNewFolder', function() {
        location.href = "/lecturer/content/material/create/{{ $dirid }}";
    })
        ...
        Swal.fire({
            ...
            if (res.isConfirmed) {
                ...
                $.ajax({
                    ...
                    url: "{{ url('lecturer/content/folder/delete') }}",
                    method: 'DELETE',
                    data: {dir: dir},
                    error: function(err) {
                        Swal.fire({
    ...
    function renameMaterial(dir) {
        ...
        $.ajax({
            headers: {'X-CSRF-TOKEN':  $('meta[name="csrf-token"]').attr('content')},
            url: "{{ url('lecturer/content/folder/rename') }}",
            method: 'POST',
