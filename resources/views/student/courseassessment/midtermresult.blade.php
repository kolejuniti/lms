    ...
    <div class="container-full">
        ...
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h4 class="page-title">{{ $data['midtermtitle'] }} [Result]</h4>
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item" aria-current="page">Academics</li>
                                <li class="breadcrumb-item" aria-current="page">Midterm</li>
                                <li class="breadcrumb-item" aria-current="page">{{ $data['midtermtitle'] }} [Result]</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-12">
                                        ...
                                        <a id="done-btn" href="/student/midterm/{{ Session::get('CourseIDS') }}/{{ $data['midtermid'] }}" class="btn btn-success pull-right" hidden>Done</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
{!! json_encode($data['midtermuserid']) !!};
...
jQuery(function($) {
    ...
    if(midterm_status == 2){
            ...
            $('#fb-rendered-form').html(`<p class="p-3 pb-2 pl-4 pr-4">Your midterm is waiting to be graded ...</p>`);
    }else{
        ...
        document.getElementById('publish-result-btn').addEventListener('click', function() {
                ...
                $.ajax({
                    ...
                    url: "{{ url('lecturer/midterm/updatemidtermresult') }}",
                    type: 'POST',
                    data:  {
                    ...
                    success:function(res){
                        location.href = "/lecturer/midterm/"+ selected_midterm +"/"+selected_participant+"/result";
                    }
                });
        }, false);
    }
