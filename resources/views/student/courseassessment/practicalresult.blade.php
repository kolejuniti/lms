    ...
    <div class="container-full">
        ...
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h4 class="page-title">{{ $data['practicaltitle'] }} [Result]</h4>
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item" aria-current="page">Academics</li>
                                <li class="breadcrumb-item" aria-current="page">Practical</li>
                                <li class="breadcrumb-item" aria-current="page">{{ $data['practicaltitle'] }} [Result]</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-12 justify-content-center" style="float: center">
                                    <div class="col-md-3 text-center mb-3">
                                        <a href="{{ ($data['return'] == null) ? '' : Storage::disk('linode')->url($data['practical']) }}">
                                            ...
                                            <div class="p-3">
                                                {{ basename($data['practical'])}} / {{ $extension = pathinfo(storage_path($data['practical']), PATHINFO_EXTENSION); }}
                                            </div>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-12">
                                        <a id="done-btn" href="/student/practical/{{ Session::get('CourseIDS') }}/{{ $data['practicalid'] }}" class="btn btn-success pull-right">Done</a>
                                    </div>
                                </div>
                                <hr>
                            </div>
...
jQuery(function($) {
    ...
    if(practical_status == 2){
            $('#fb-rendered-form').css('width','100%');
            $('#fb-rendered-form').html(`<p class="p-3 pb-2 pl-4 pr-4">Your practical is waiting to be graded ...</p>`);
    }else{
    ...
    renderForm(practical);
    
    setTimeout(() => {
        renderMark();

        //remove editing features if published
        if( practical_status == 3 ){ 
