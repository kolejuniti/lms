                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="project-actions text-center" >
                                @if (empty($sts))
                                <a class="btn btn-success btn-sm mr-2" href="/student/paperwork/{{ Session::get('CourseIDS') }}/{{ request()->paperwork }}/view">
                                  <i class="ti-user">
                                  </i>
                                  Answer
                                </a>
                                @elseif (!empty($sts))
                                <a class="btn btn-success btn-sm mr-2" href="/student/paperwork/{{ request()->paperwork }}/{{ Session::get('StudInfos')->ic }}/result">
                                  <i class="ti-user">
                                  </i>
                                  Result
                                </a>
