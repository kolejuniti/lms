                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-12">
                                        ...
                                        <a id="done-btn" href="/student/final/{{ Session::get('CourseIDS') }}/{{ $data['finalid'] }}" class="btn btn-success pull-right" hidden>Done</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
jQuery(function($) {
    ...
    if(final_status == 2){
            ...
            $('#fb-rendered-form').html(`<p class="p-3 pb-2 pl-4 pr-4">Your final is waiting to be graded ...</p>`);
    }else{
