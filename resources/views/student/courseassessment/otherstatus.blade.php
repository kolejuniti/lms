                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="project-actions text-center" >
                                @if (empty($sts))
                                <a class="btn btn-success btn-sm mr-2" href="/student/other/{{ Session::get('CourseIDS') }}/{{ request()->other }}/view">
                                  <i class="ti-user">
                                  </i>
                                  Answer
                                </a>
                                @elseif (!empty($sts))
                                <a class="btn btn-success btn-sm mr-2" href="/student/other/{{ request()->other }}/{{ Session::get('StudInfos')->ic }}/result">
                                  <i class="ti-user">
                                  </i>
                                  Result
                                </a>
