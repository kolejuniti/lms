    ...
    <div class="container-full">
        ...
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h4 class="page-title">{{ $data['quiz2title'] }} [Result]</h4>
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item" aria-current="page">Academics</li>
                                <li class="breadcrumb-item" aria-current="page">Extra</li>
                                <li class="breadcrumb-item" aria-current="page">{{ $data['quiz2title'] }} [Result]</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6 p-4">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-9">{{ $data['quiz2title'] }}</div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-md-3"><b>Due Date</b></div>
                        <div class="col-md-9">{{ $data['deadline'] }}</div>
                    </div>
                    <div class="row mb-2">
                    ...
                    <div class=" d-flex justify-content-center">
                        <div id="fb-rendered-form" class="card" style="width:800px">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h1 class="pull-left"> {{ $data['quiz2title'] }}</h1>
                                ...
                                <div class="col-md-12 justify-content-center" style="float: center">
                                    <div class="col-md-3 text-center mb-3">
                                        <a href="{{ ($data['return'] == null) ? '' : Storage::disk('linode')->url($data['quiz2']) }}">
                                            ...
                                            <div class="p-3">
                                                {{ basename($data['quiz2'])}} / {{ $extension = pathinfo(storage_path($data['quiz2']), PATHINFO_EXTENSION); }}
                                            </div>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-12">
                                        <a id="done-btn" href="/student/quiz2/{{ Session::get('CourseIDS') }}/{{ $data['quizid'] }}" class="btn btn-success pull-right">Done</a>
                                    </div>
                                </div>
                                <hr>
                            </div>
...
var quiz2 = {!! json_encode($data['quiz2']) !!};
var selected_quiz2 = {{ json_encode($data['quizid']) }};
var selected_participant = {{ json_encode($data['quiz2userid']) }};
var quiz2_status = {{ json_encode($data['studentquiz2status']) }};
...
jQuery(function($) {
    ...
    if(quiz2_status == 2){
            ...
            $('#fb-rendered-form').html(`<p class="p-3 pb-2 pl-4 pr-4">Your quiz2 is waiting to be graded ...</p>`);
    }else{
