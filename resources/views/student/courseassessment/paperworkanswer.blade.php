    ...
    <div class="container-full">
        ...
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h4 class="page-title">{{ $data['paperworktitle'] }}</h4>
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{ $data['paperworktitle'] }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <section class="content">
            <form action="/student/paperwork/submitpaperwork?id={{ $data['paperworkid'] }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
...
var selected_paperwork = "{{ $data['paperworkid'] }}";
