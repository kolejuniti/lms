                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-12 justify-content-center" style="float: center">
                                    <div class="col-md-3 text-center mb-3">
                                        <a href="{{ ($data['return'] == null) ? '' : asset('storage/'. $data['paperwork']) }}" download>
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-12">
                                        <a id="done-btn" href="/student/paperwork/{{ Session::get('CourseIDS') }}/{{ $data['paperworkid'] }}" class="btn btn-success pull-right">Done</a>
                                    </div>
                                </div>
                                <hr>
                            </div>
...
jQuery(function($) {
    ...
    if(paperwork_status == 2){
            $('#fb-rendered-form').css('width','100%');
            $('#fb-rendered-form').html(`<p class="p-3 pb-2 pl-4 pr-4">Your paperwork is waiting to be graded ...</p>`);
    }else{
