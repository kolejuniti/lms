                                ...
                                <td class="project-actions text-center" >
                                  @if (empty($sts) || ($sts->status == 1) )
                                    @if ($qz->status == 2)
                                      ...
                                      <a class="btn btn-success btn-sm mr-2" href="/student/test/{{ Session::get('CourseIDS') }}/{{ request()->test }}/view">
                                        <i class="ti-user">
                                        </i>
                                        Answer
                                      </a>
                                    ...
                                    @endif
                                  @elseif (!empty($sts))
                                  <a class="btn btn-success btn-sm mr-2" href="/student/test/{{ request()->test }}/{{ Session::get('StudInfos')->ic }}/result">
                                    <i class="ti-user">
                                    </i>
                                    Result
                                  </a>
