                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="project-actions text-center" >
                                @if (empty($sts))
                                <a class="btn btn-success btn-sm mr-2" href="/student/quiz2/{{ Session::get('CourseIDS') }}/{{ request()->quiz2 }}/view">
                                  <i class="ti-user">
                                  </i>
                                  Answer
                                </a>
                                @elseif (!empty($sts))
                                <a class="btn btn-success btn-sm mr-2" href="/student/quiz2/{{ request()->quiz2 }}/{{ Session::get('StudInfos')->ic }}/result">
                                  <i class="ti-user">
                                  </i>
                                  Result
                                </a>
