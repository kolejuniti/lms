    ...
    <div class="container-full">
        ...
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h4 class="page-title">{{ $data['quiztitle'] }}</h4>
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{ $data['quiztitle'] }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class=" d-flex justify-content-center">
                        <div class="box text-center">
                            ...
                            <div class="box-body">
                                <h1 class="countnm fs-40 m-0" id="quiz-timer">
...
function startQuiz(){
    ...
    $.ajax({
        ...
        url: "{{ url('student/quiz/startquiz') }}",
        type: 'POST',
        data:  {
            quiz: selected_quiz,
        },
...
jQuery(function($) {
    ...
    document.getElementById('submit-btn').addEventListener('click', function() {
        ...
        $.ajax({
            headers: {'X-CSRF-TOKEN':  $('meta[name="csrf-token"]').attr('content')},
            url: "{{ url('student/quiz/submitquiz') }}",
            type: 'POST',
            data:  {
                id: selected_quiz,
                data: window.JSON.stringify( {formData: $(fbRender).formRender("userData") })
            ...
            success:function(res){
                if(!res.status){
                    alert(res.message);
                    location.href = "/student/quiz/{{ Session::get('CourseIDS') }}/"+ selected_quiz;
                }else{
                    location.href = "/student/quiz/{{ Session::get('CourseIDS') }}/"+ selected_quiz;
                }
            }
