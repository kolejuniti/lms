                    ...
                    <div class=" d-flex justify-content-center">
                        <div id="fb-rendered-form" class="card" style="width:800px">
                            <div class="card-body">
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-12">
                                        <a id="done-btn" href="/student/assign/{{ Session::get('CourseIDS') }}/{{ $data['assignid'] }}" class="btn btn-success pull-right">Done</a>
                                    </div>
                                </div>
                                <hr>
                            </div>
...
jQuery(function($) {
    ...
    if(assign_status == 2){
            ...
            $('#fb-rendered-form').html(`<p class="p-3 pb-2 pl-4 pr-4">Your assign is waiting to be graded ...</p>`);
    }else{
