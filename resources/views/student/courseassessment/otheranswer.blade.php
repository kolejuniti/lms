    ...
    <div class="container-full">
        ...
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h4 class="page-title">{{ $data['othertitle'] }}</h4>
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{ $data['othertitle'] }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <section class="content">
            <form action="/student/other/submitother?id={{ $data['otherid'] }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6 p-4">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-3"><b>Extra Title</b></div>
...
var selected_other = "{{ $data['otherid'] }}";
