    ...
    <div class="container-full">
        ...
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h4 class="page-title">{{ $data['quiz2title'] }}</h4>
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{ $data['quiz2title'] }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <section class="content">
            <form action="/student/quiz2/submitquiz2?id={{ $data['quizid'] }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
...
var selected_quiz2 = "{{ $data['quizid'] }}";
