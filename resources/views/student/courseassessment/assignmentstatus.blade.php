                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="project-actions text-center" >
                                @if (empty($sts))
                                <a class="btn btn-success btn-sm mr-2" href="/student/assign/{{ Session::get('CourseIDS') }}/{{ request()->assign }}/view">
                                  <i class="ti-user">
                                  </i>
                                  Answer
                                </a>
                                @elseif (!empty($sts))
                                <a class="btn btn-success btn-sm mr-2" href="/student/assign/{{ request()->assign }}/{{ Session::get('StudInfos')->ic }}/result">
                                  <i class="ti-user">
                                  </i>
                                  Result
                                </a>
