  ...
  <div class="container-full">
    ...
    <div class="content-header">
      <div class="d-flex align-items-center">
        <div class="me-auto">
          <h4 class="page-title">Sponsor Payment Report</h4>
          <div class="d-inline-block align-items-center">
            <nav>
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                <li class="breadcrumb-item" aria-current="page">Dashboard</li>
                <li class="breadcrumb-item active" aria-current="page">Sponsor Payment Report</li>
              </ol>
            </nav>
          </div>
        </div>
            ...
            <div class="col-md-6 ml-3">
              <div class="form-group">
                  ...
                  <select class="form-select" id="sponsor" name="sponsor">
                    ...
                    @foreach ($data['sponsor'] as $spn)
                    <option value="{{ $spn->id }}">{{ $spn->code }} - {{ $spn->name}}</option> 
                    @endforeach
                  </select>
              </div>
            </div>
...
<script>
  ...
  <script type="text/javascript">
    ...
    function submit()
    {
      ...
      $.ajax({
          headers: {'X-CSRF-TOKEN':  $('meta[name="csrf-token"]').attr('content')},
          url: '{{ url('/finance/sponsorship/payment/report/getReport') }}',
          type: 'POST',
          data: formData,
          cache : false,
          processData: false,
