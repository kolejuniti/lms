   ...
   <style>
      ...
      @media print {
         ...
         hr {
            ...
            /* make sure the color is dark enough */
         }
      }
      ...
      <div class="col-12">
            ...
            <div class="d-flex p-2">
               <div class="col-md-6" style="margin-right: 10px">
                  <div class="form-group">
                     ...
                     <p>No. Resit &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: &nbsp;&nbsp; {{ (isset($invois)) ? $data['payment']->ref_no : $data['payment']->id }}</p>
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     @if(!empty($data['payment']->remark))
                     <p>Remark &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: &nbsp;&nbsp; {{ $data['payment']->remark }}</p>
                     @endif
                  </div>
               </div>
            </div>
               ...
               <table>
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td class="text-center; width: 50px;"><strong>Jumlah :</strong></td>
               ...
               <table>
                  <thead>
                     <tr class="line">
                        ...
                        <td class="text-center; width: 50px;"><strong>CATATAN</strong></td>
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td class="text-center; width: 50px;"><strong>Jumlah Keseluruhan :</strong></td>
                        <td class="text-center; width: 50px;"><strong>{{ number_format($data['total'], 2, '.', ',') }}</strong></td>
                     </tr>
                  </tbody>
               </table>
         ...
         <div class="row">
            <div class="col-md-12 text-right identity">
               <p>Received By :<br><strong>{{ $data['staff']->name ?? 'N/A' }}</strong></p>
            </div>
         </div>
      </div>
   </div>
