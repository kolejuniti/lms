          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Student Sponsorship Payment</h3>
              </div>
              <!-- /.card-header -->
              <div class="card mb-3">
                <div class="card-header">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <p>Sponsorship Name &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: &nbsp;&nbsp; {{ $payment->name }}</p>
                      </div>
                    </div>
                  </div>
                  <div class="row">
...
function getStudInfo(student)
{
    return $.ajax({
            headers: {'X-CSRF-TOKEN':  $('meta[name="csrf-token"]').attr('content')},
            url      : "{{ url('finance/sponsorship/payment/student/getStudent') }}",
            method   : 'POST',
...
function save(ic)
{
  ...
  $.ajax({
        headers: {'X-CSRF-TOKEN':  $('meta[name="csrf-token"]').attr('content')},
        url: '{{ url('/finance/sponsorship/payment/student/storeStudent') }}',
        type: 'POST',
        data: formData,
        cache : false,
        processData: false,
...
function confirm()
{
  ...
  if(sum != '' && sum2 != '')
  {
    ...
    $.ajax({
          headers: {'X-CSRF-TOKEN':  $('meta[name="csrf-token"]').attr('content')},
          url: '{{ url('/finance/sponsorship/payment/student/confirmStudent') }}',
          type: 'POST',
          data: formData,
          cache : false,
          processData: false,
