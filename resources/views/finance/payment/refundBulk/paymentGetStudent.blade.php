        ...
        <div class="card-body">
            <div class="row">       
                <div class="col-md-6" id="payment-card">
                    <div class="form-group">
                        <label class="form-label" for="ptotal">Total Refund Amount</label>
                        <input type="number" class="form-control" name="ptotal" id="ptotal" step="0.01">
                    </div>
                </div> 
            </div>
            ...
            <div class="row">
                <div class="col-md-12 mt-3">
                    <div class="form-group mt-3">
                        <label class="form-label">Student Payment History (For Refund)</label>
                                    ...
                                    <td>
                                        <div class="col-md-12" id="payment-card">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" name="payment[]" id="payment[]" step='0.01' max="{{ $data['balance'][$key] }}">
                                            </div>
                                        </div> 
                                    </td>
                                </tr>
