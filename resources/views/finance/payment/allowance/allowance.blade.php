          ...
          <div class="d-inline-block align-items-center">
            <nav>
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Allowance</li>
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Allowance's Payment</h3>
        </div>
        <div class="card-body">
          <div class="row mb-3 d-flex">
            <div class="col-md-12 mb-3">
              <div class="pull-right">
                  <a type="button" class="waves-effect waves-light btn btn-info btn-sm" href="/finance/payment/allowance/payment/input">
                      <i class="fa fa-plus"></i> <i class="fa fa-object-group"></i> &nbsp Add Allowance
                  </a>
              </div>
            </div>
        </div>
            ...
            @foreach ($payment as $key => $pym)
              <tr>
                ...
                <td class="project-actions text-right" style="text-align: center;">
                  <a class="btn btn-info btn-sm btn-sm mr-2" href="/finance/payment/allowance/student?id={{ $pym->id }}">
                      <i class="ti-pencil-alt">
                      </i>
                      Student
                  </a>
                  <a class="btn btn-danger btn-sm" href="#" onclick="deleteAllowance('{{ $pym->id }}')">
                      <i class="ti-trash">
                      </i>
                      Delete
                  </a>
  ...
  function deleteAllowance(id){     
    ...
    if (res.isConfirmed){
              $.ajax({
                  ...
                  url      : "{{ url('finance/payment/allowance/payment/delete') }}",
                  method   : 'POST',
                  data 	 : {id:id},
                  error:function(err){
                      alert("Error");
