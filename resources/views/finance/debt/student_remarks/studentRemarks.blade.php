...
<div class="content-wrapper" style="min-height: 695.8px;">
  ...
  <div class="content-header">
    <div class="d-flex align-items-center">
      <div class="me-auto">
        <h4 class="page-title">Student Remarks</h4>
        <div class="d-inline-block align-items-center">
          <nav>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
              <li class="breadcrumb-item" aria-current="page">Dashboard</li>
              <li class="breadcrumb-item active" aria-current="page">Student Remarks</li>
            </ol>
          </nav>
        </div>
      </div>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Update Student Remarks</h3>
              </div>
              <!-- /.card-header -->
              <div class="card mb-3">
                <div class="card-header">
...
function getStudInfo(student)
{
    return $.ajax({
            headers: {'X-CSRF-TOKEN':  $('meta[name="csrf-token"]').attr('content')},
            url      : "{{ url('finance/debt/studentRemarks/getStudentRemarks') }}",
            method   : 'POST',
...
function submitForm(ic)
{
    ...
    if(forminput.categories == '' || forminput.comment == '' || forminput.correction == '' || forminput.current == '')
    {
      ...
      $.ajax({
          headers: {'X-CSRF-TOKEN':  $('meta[name="csrf-token"]').attr('content')},
          url: '{{ url('/finance/debt/studentRemarks/storeStudentRemarks') }}',
          type: 'POST',
          data: formData,
          cache : false,
          processData: false,
          ...
          success:function(res){
              try{
                  if(res.message == "Success"){
                      alert("Success! Student Remark has been added!")
