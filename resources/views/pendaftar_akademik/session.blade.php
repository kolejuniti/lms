      ...
      <div class="card">
            ...
            <div class="col-md-12 mb-3">
                <div class="pull-right">
                    <a type="button" class="waves-effect waves-light btn btn-info btn-sm" data-toggle="modal" data-target="#uploadModal">
                        <i class="fa fa-plus"></i> <i class="fa fa-object-group"></i> &nbsp Add Session
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="card-body p-0">
          <table id="myTable" class="table table-striped projects display dataTable">
            ...
            <tbody id="table">
            @foreach ($data['session'] as $key=> $ses)
              <tr>
                <td style="width: 1%">
                  {{ $key+1 }}
                </td>
                ...
                <td class="project-actions text-right" style="text-align: center;">
                  <a class="btn btn-info btn-sm btn-sm mr-2" href="#" onclick="updateSession('{{ $ses->SessionID }}')">
                      <i class="ti-pencil-alt">
                      </i>
                      Edit
                  </a>
                  <a class="btn btn-danger btn-sm" href="#" onclick="deleteSession('{{ $ses->SessionID }}')">
                      <i class="ti-trash">
                      </i>
                      Delete
                  </a>
                        ...
                        <div>
                          <div class="form-group">
                              ...
                              <option value="-" selected disabled>-</option>
                                ...
                                <option value="OGS">August</option>
