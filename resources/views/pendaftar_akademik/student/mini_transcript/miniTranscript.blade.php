            ...
            <tbody id="table">
              {{-- <tr>
                ...
                <td>
                  <div class="col-md-6">
                    <div class="form-group">
                      <input type="date" class="form-control" id="data-{{ '1' }}">
                    </div>
                  </div>
                </td>
                <td class="project-actions text-right" >
                  <a class="btn btn-info btn-sm btn-sm mr-2" onclick="print()">
...
<script src="{{ asset('assets/src/js/pages/data-table.js') }}"></script>
  ...
  function getStudent(search)
  {
    ...
    return $.ajax({
        ...
        url      : "{{ url('AR/student/transcript/getStudentTranscript') }}",
        method   : 'POST',
        data 	 : {search: search},
  ...
  function print(ic)
  {
      ...
      return $.ajax({
            headers: {'X-CSRF-TOKEN':  $('meta[name="csrf-token"]').attr('content')},
            url      : "{{ url('AR/student/miniTranscript/printStudentMiniTranscript') }}",
            method   : 'POST',
