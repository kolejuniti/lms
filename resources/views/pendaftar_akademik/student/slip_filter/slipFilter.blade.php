  ...
  <div class="container-full">
    ...
    <div class="content-header">
      <div class="d-flex align-items-center">
        <div class="me-auto">
          <h4 class="page-title">Slip Exam Filter</h4>
          <div class="d-inline-block align-items-center">
            <nav>
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                <li class="breadcrumb-item" aria-current="page">Dashboard</li>
                <li class="breadcrumb-item active" aria-current="page">Slip Exam Filter</li>
              </ol>
            </nav>
          </div>
        </div>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="editModalLabel">Edit Slip Filter</h5>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <select class="form-select" id="editProgram" name="editProgram" multiple style="height: 200px;">
                  @foreach ($data['program'] as $prg)
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <select class="form-select" id="editSemester" name="editSemester" multiple style="height: 200px;">
                  @foreach ($data['semester'] as $sem)
  ...
  <script type="text/javascript">
    ...
    function submit()
    {
        ...
        return $.ajax({
                  ...
                  url      : "{{ url('AR/student/slipFilter/submit') }}",
                  method   : 'POST',
                  cache : false,
                  processData: false,
                  contentType: false,
    ...
    function editRecord(id) {
        ...
        $.ajax({
            headers: {'X-CSRF-TOKEN':  $('meta[name="csrf-token"]').attr('content')},
            url: "{{ url('AR/student/slipFilter/get') }}/" + id,
            method: 'GET',
            success: function(data) {
                if (data) {
                    $('#editId').val(data.id);
    ...
    function updateRecord() {
        ...
        $.ajax({
            headers: {'X-CSRF-TOKEN':  $('meta[name="csrf-token"]').attr('content')},
            url: "{{ url('AR/student/slipFilter/edit') }}/" + currentEditId,
            method: 'POST',
            cache: false,
            processData: false,
            contentType: false,
    ...
    function deleteRecord(id) {
        if (confirm('Are you sure you want to delete this record?')) {
            $.ajax({
                headers: {'X-CSRF-TOKEN':  $('meta[name="csrf-token"]').attr('content')},
                url: "{{ url('AR/student/slipFilter/delete') }}/" + id,
                method: 'DELETE',
                success: function(data) {
                    if(data.error) {
                        alert(data.error);
    ...
    // Initialize DataTable for the slip records
    $(document).ready(function() {
        $('#slipTable').DataTable({
            dom: 'lBfrtip',
            buttons: [
