...
Route::get('/admin/report/academicStaffProgram', [App\Http\Controllers\AdminController::class, 'academicStaffProgram'])->name('admin.report.academicStaffProgram');
Route::post('/admin/report/academicStaffProgram/get', [App\Http\Controllers\AdminController::class, 'getAcademicStaffProgram'])->name('admin.report.academicStaffProgram.get');
Route::get('/admin/report/academicStaffProgram/export', [App\Http\Controllers\AdminController::class, 'exportAcademicStaffProgram'])->name('admin.report.academicStaffProgram.export');
...
Route::post('/pendaftar/spm/{ic}/SKKstore', [App\Http\Controllers\PendaftarController::class, 'SKKStore'])->name('pendaftar.skk.store');
...
Route::get('/pendaftar/student/status/statusUpdateBulk', [App\Http\Controllers\PendaftarController::class, 'statusUpdateBulk'])->name('pendaftar.student.statusUpdateBulk');
Route::get('/pendaftar/student/status/getStatusUpdateBulk', [App\Http\Controllers\PendaftarController::class, 'getStatusUpdateBulk']);
Route::post('/pendaftar/student/status/updateStatusUpdateBulk', [App\Http\Controllers\PendaftarController::class, 'updateStatusUpdateBulk']);
...
Route::post('/AR/assignCourse/getSubjectsByFilter', [App\Http\Controllers\AR_Controller::class, 'getSubjectsByFilter']);
Route::post('/AR/assignCourse/storeCourseToStructure', [App\Http\Controllers\AR_Controller::class, 'storeCourseToStructure']);
Route::post('/AR/assignCourse/getIntakesForCourse', [App\Http\Controllers\AR_Controller::class, 'getIntakesForCourse']);
Route::post('/AR/assignCourse/deleteByIntakes', [App\Http\Controllers\AR_Controller::class, 'deleteByIntakes']);
...
Route::get('/AR/schedule/fetch/{id}/fetchExistEvent', [App\Http\Controllers\AR_Controller::class, 'fetchExistEvent']);
...
Route::post('/AR/student/certificate/updateDetails', [App\Http\Controllers\AR_Controller::class, 'updateCertificateDetails']);
Route::post('/AR/student/certificate/checkAvailability', [App\Http\Controllers\AR_Controller::class, 'checkSerialNumberAvailability']);
Route::post('/AR/student/certificate/bulkGenerate', [App\Http\Controllers\AR_Controller::class, 'bulkGenerateCertificates']);
...
Route::post('/lecturer/quiz/manual-mark', [App\Http\Controllers\QuizController::class, 'manualMarkQuiz']);
...
Route::get('/student/vehicle_register', [App\Http\Controllers\StudentController::class, 'vehicleSticker'])->name('student.vehicle_sticker');
Route::get('/student/vehicle_register/print/{id}', [App\Http\Controllers\StudentController::class, 'printVehicleSticker'])->name('student.vehicle_sticker.print');
Route::post('/student/vehicle_register/store', [App\Http\Controllers\StudentController::class, 'storeVehicleSticker'])->name('student.vehicle_sticker.store');
Route::delete('/student/vehicle_register/{id}', [App\Http\Controllers\StudentController::class, 'deleteVehicleSticker'])->name('student.vehicle_sticker.delete');
...
Route::get('/student/announcements/getBanner', [App\Http\Controllers\AllController::class, 'getBannerAnnouncement'])->middleware('auth:student');
