            ...
            <div class="row">
                <div class="col-md-6 p-4">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-9">{{ $data['quiz2deadline'] }}</div>
                    </div>
                    <div class="row mb-2">
                    ...
                    <div class=" d-flex justify-content-center">
                        <div id="fb-rendered-form" class="card" style="width:800px">
                            <div class="card-body">
                                ...
                                <hr>
                                <form action="/lecturer/quiz2/updatequiz2result?id={{ request()->quizid }}&participant={{ $data['IC'] }}" id="form-submit"  method="POST" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <div id="form-show" hidden>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-12">
                                            <a id="done-btn" href="/lecturer/quiz2/{{ Session::get('CourseIDS') }}/{{ $data['quizid'] }}" class="btn btn-success pull-right">Done</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
