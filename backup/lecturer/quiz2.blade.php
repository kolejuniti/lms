                        ...
                        <table id="myTable" class="table table-striped projects display dataTable no-footer" style="width: 100%;" role="grid" aria-describedby="complex_header_info">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="align-items-center">
                                <a class="btn btn-primary btn-sm btn-sm mr-2" href="#" onclick="clickDesc('{!! $dt->description !!}')">
                              ...
                              <td class="project-actions text-right" >
                                <a class="btn btn-success btn-sm mr-2" href="/lecturer/quiz2/{{ Session::get('CourseIDS') }}/{{ $dt->id }}">
                                    <i class="ti-user">
                                    </i>
                                    Students
                                </a>
...
$(document).ready( function () {
    ...
    $(document).on('click', '#newFolder', function() {
        location.href = "/lecturer/quiz2/{{ Session::get('CourseID') }}/create";
    })
