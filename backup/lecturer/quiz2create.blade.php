    ...
    <div class="container-full">
        ...
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h4 class="page-title">
                        {{ empty($data['quiz2']->title) ? "Create Quiz" : $data['quiz2']->title }}
                    </h4>
                        ...
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Group Content</li>
                                    ...
                                    @if(empty($data['quiz2']->title))
                                        <li class="breadcrumb-item active" aria-current="page">Create Quiz</li>
                                    @else
                                        <li class="breadcrumb-item active" aria-current="page">Quiz</li>
                                        <li class="breadcrumb-item active" aria-current="page">{{ $data['quiz2']->title }}</li>
                                    @endif
                                </li>
        ...
        <section class="content">
            <div class="row">
                <form action="/lecturer/quiz2/insert" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="header-setting row">
                                <div class="row col-md-12">
                                    <div class="col-md-3 mb-4">
                                        <label for="quiz2-title" class="form-label "><strong>Quiz Title</strong></label>
                                        <input type="text" oninput="this.value = this.value.toUpperCase()"  id="quiz2-title" name="quiz2-title" class="form-control"
                                            value="{{ empty($data['quiz2']->title) ? "" : $data['quiz2']->title }}" required>
                                    </div>
                                    <div class="col-md-2 mb-4">
                                        <label for="quiz2-duration" class="form-label "><strong>Quiz Deadline</strong></label>
                                        <input type="datetime-local" oninput="this.value = this.value.toUpperCase()"  id="quiz2-duration" name="quiz2-duration" class="form-control"
                                            value="" required>
                                    </div>
                                    <div class="col-md-2 mb-4">
                                ...
                                <div class="row col-md-12">
                                    ...
                                    <div class="col-md-3 mb-4">
                                        <div class="form-group">
                                            <label for="total-marks" class="form-label"><strong>Content</strong> (Optional)</label>
